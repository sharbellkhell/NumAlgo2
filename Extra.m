...
%  THIS IS EXTRA NOT FOR HW
%  (The code required for Q5.3 is found in clause_3.m)
%  This is an extra solution i wanted to implement that works 
%  very simmilarly to mergeSort by slicing each 
%  Identification problem into two smaller ranges .
